...
namespace Portal.Repositories
{
    ...
    public class RoleRepository : IRoleRepository
    {
        ...
        public async Task<Role> Get(long Id)
        {
            ...
            Role.ApplicationUsers = await DataContext.UserRoleMapping
                .Where(x => x.RoleId == Role.Id)
        ...
        public async Task<bool> Delete(Role Role)
        {
            ...
            await DataContext.UserRoleMapping.Where(x => x.RoleId == Role.Id).DeleteFromQueryAsync();
        ...
        public async Task<bool> BulkDelete(List<Role> Roles)
        {
            ...
            await DataContext.UserRoleMapping.Where(x => Ids.Contains(x.RoleId)).DeleteFromQueryAsync();
        ...
        private async Task SaveReference(Role Role)
        {
            ...
            await DataContext.UserRoleMapping.Where(x => x.RoleId == Role.Id).DeleteFromQueryAsync();
            if (Role.ApplicationUsers != null)
            {
                List<UserRoleMappingDAO> UserRoleMappingDAOs = Role.ApplicationUsers
